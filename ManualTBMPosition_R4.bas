Attribute VB_Name = "ManualTBMPosition_R4"
...
Sub TBMPosition()
    ...
    TgtB_SHV(0) = DirecSDHAVAby3P(TS(2), TS(1), TS(3), BS(2), BS(1), BS(3), TgtA(2), TgtA(1), TgtA(3), "H") 'Hor. Angle
    TgtB_SHV(1) = DirecSDHAVAby3P(TS(2), TS(1), TS(3), BS(2), BS(1), BS(3), TgtA(2), TgtA(1), TgtA(3), "V") 'Ver. Angle
    TgtB_SHV(2) = DirecSDHAVAby3P(TS(2), TS(1), TS(3), BS(2), BS(1), BS(3), TgtA(2), TgtA(1), TgtA(3), "S") 'Slope Dist.
